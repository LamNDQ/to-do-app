  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (err.response?.status === 404) {
        ...
        setError("Invalid API key. Please set your OpenWeatherMap API key in services/weatherService.js");
      } else {
    ...
    <div className="page-wrapper">
      ...
      <div className="page-header">
        ...
        <div>
          ...
          <p className="page-subtitle">Real-time weather for any city.</p>
        </div>
      </div>
      ...
      {weather && (
        <div className="weather-card">
          ...
          <div className="weather-details">
            ...
            <div className="detail-item">
              <span className="detail-icon">🌡️</span>
              <span className="detail-val">{Math.round(weather.main.temp_max)}° / {Math.round(weather.main.temp_min)}°</span>
